...
class CMainWindow : public CWindow {
	...
	public:
		...
		int OnEncodeEucJp(WPARAM wParam, LPARAM lParam);	// "EUC-JP"が選択された時.
		int OnEncodeJis(WPARAM wParam, LPARAM lParam);	// "JIS"が選択された時.
		...
		int OnBomUtf8(WPARAM wParam, LPARAM lParam);	// "UTF-8 BOM"が選択された時.
